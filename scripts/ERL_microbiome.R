...
setwd('/home/lakinsm/Documents/ferrisBioinformatics/2017Feb14_microbiome/')
...
exploratory_analyses = list(
    ...
    list(
        ...
        subsets = list('Horse != HBlank'),
        exploratory_var = 'SamplingLocation'
    ),
    ...
    list(
        name = 'DzClitoris',
        subsets = list('Horse != HBlank', 'SamplingLocation == Clitoris'),
        exploratory_var = 'DiseaseStatus'
    ),
    ...
    list(
        name = 'DzVestibule',
        subsets = list('Horse != HBlank', 'SamplingLocation == Vestibule'),
        exploratory_var = 'DiseaseStatus'
    ),
    ...
    list(
        name = 'DzVagina',
        subsets = list('Horse != HBlank', 'SamplingLocation == Vagina'),
        exploratory_var = 'DiseaseStatus'
    ),
    ...
    list(
        name = 'DzUterus',
        subsets = list('Horse != HBlank', 'SamplingLocation == Uterus'),
        exploratory_var = 'DiseaseStatus'
    ),
    ...
    # Description: 
    list(
        name = 'UterusSamplingMethod',
        subsets = list('Horse != HBlank', 'SamplingLocation == Uterus'),
        exploratory_var = 'SamplingMethod'
    ),
    
    # Analysis 7
    # Description: 
    list(
        name = 'EstrusStatusClitoris',
        subsets = list('Horse != HBlank', 'SamplingLocation == Clitoris'),
        exploratory_var = 'EstrusStatus'
    ),
    
    # Analysis 8
    # Description: 
    list(
        name = 'EstrusStatusVestibule',
        subsets = list('Horse != HBlank', 'SamplingLocation == Vestibule'),
        exploratory_var = 'EstrusStatus'
    ),
...
statistical_analyses = list(
  ...
  list(
    name = 'LocationNoCov',
    subsets = list('Horse != HBlank'),
    model_matrix = '~ 0 + SamplingLocation',
    contrasts = list('SamplingLocationClitoris - SamplingLocationVestibule',
                     'SamplingLocationClitoris - SamplingLocationVagina',
                     'SamplingLocationClitoris - SamplingLocationUterus',
                     'SamplingLocationVestibule - SamplingLocationVagina',
                     'SamplingLocationVestibule - SamplingLocationUterus',
                     'SamplingLocationVagina - SamplingLocationUterus'),
    random_effect = NA
  ),
  ...
  # Description: 
  list(
      name = 'LocationDzFixed',
      subsets = list('Horse != HBlank'),
      model_matrix = '~ 0 + SamplingLocation + DiseaseStatus',
      contrasts = list('SamplingLocationClitoris - SamplingLocationVestibule',
                       'SamplingLocationClitoris - SamplingLocationVagina',
                       'SamplingLocationClitoris - SamplingLocationUterus',
                       'SamplingLocationVestibule - SamplingLocationVagina',
  ...
  # Description: 
  list(
      name = 'LocationDzFixedHorseRandom',
      subsets = list('Horse != HBlank'),
      model_matrix = '~ 0 + SamplingLocation + DiseaseStatus',
      contrasts = list('SamplingLocationClitoris - SamplingLocationVestibule',
                       'SamplingLocationClitoris - SamplingLocationVagina',
  ...
  list(
      name = 'DiseaseStatus',
      subsets = list('Horse != HBlank'),
      model_matrix = '~ 0 + DiseaseStatus',
      contrasts = list('DiseaseStatusDiseased - DiseaseStatusNormal'),
      random_effect = NA
  ),
  ...
  # Description: 
  list(
      name = 'DiseaseStatusLocationFixed',
      subsets = list('Horse != HBlank'),
      model_matrix = '~ 0 + DiseaseStatus + SamplingLocation',
      contrasts = list('DiseaseStatusDiseased - DiseaseStatusNormal'),
      random_effect = NA
  ),
  ...
  # Description: 
  list(
      name = 'DiseaseStatusLocationFixedHorseRandom',
      subsets = list('Horse != HBlank'),
      model_matrix = '~ 0 + DiseaseStatus + SamplingLocation',
      contrasts = list('DiseaseStatusDiseased - DiseaseStatusNormal'),
      random_effect = 'Horse'
